...
**Projeto Integrador II - Unifacisa (2026.1)**
**Competência:** 222015 - PROJETO INTEGRADOR II - NOITE
...
* **Missões:** Desafios dinâmicos que bonificam o utilizador com XP.
...
1. **Fundação e Dados:** "Crie um app usando a API do TMDB onde se pesquisa filmes e series... as informacoes precisam ser práticas: Sinopse, Nota, trailers, streaming onde ele esta, temporadas e status."
2. **Evolução da Arquitetura (Supabase):** "CineSearch Evolution: Implementa sistema de login/registo com Supabase Auth. Cria tabelas de profiles e user_interactions. Adiciona botões de Favoritar/Assistir no MediaCard com mutações do TanStack Query."
3. **Refinamento de Gamificação e Social:** "Precisa melhorar a gamificacao... implementar sistema de missoes, ranking publico, poder um usuario seguir o outro e sistema de comentarios. As recomendacoes devem ser baseadas no que foi assistido e favoritadas."
...
O desenvolvimento foi impactado pelas **limitações de quotas de prompts e processamento da ferramenta Lovable.dev**. Devido a esses limites operacionais da plataforma de IA, algumas iterações complexas de interface e polimento de regras de negócio sociais estão agendadas para as próximas fases. Contudo, o fluxo principal (Busca, Auth, XP e IA) está operacional.
...
---
**Desenvolvido por:** [Nereu Jr.](https://github.com/nereuvjr-br)
